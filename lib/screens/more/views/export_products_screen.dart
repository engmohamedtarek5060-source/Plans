// ==================== export_products_screen.dart ====================
import 'package:flutter/material.dart';
import 'package:saudiaaaa/screens/more/views/widgets/preview_card.dart';

class ExportProductsScreen extends StatelessWidget {
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        isEnglish ? 'Export Products' : 'تصدير المنتجات',
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                isEnglish
                                    ? 'Export products with complete data'
                                    : 'تصدير المنتجات مع البيانات الكاملة',
                                style: const TextStyle(
                                  color: Colors.white,
                                  fontSize: 16,
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                _buildSection(
                  ...
                  child: _buildFormatSelector('CSV'),
                ),
                const SizedBox(height: 20),
                _buildSection(
